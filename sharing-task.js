...
// Task 2: Write a function to calculate the total cost of the event given thenumber of attendees and the cost per attendee. If the number of attendees exceeds 100, apply a 10% discount to the total cost.
...
function calculateCost(numberOfAttendees, costPerAttendee){
    ...
    if (numberOfAttendees > 100) {total = total * 0.9}
    else {total}
        return total
}
